...
See [`backend/README.md`](./backend/README.md) for setup instructions specific to this service.
...
See [`certificate-api/README.md`](./certificate-api/README.md) for setup instructions specific to this service.
...
This repo was created by merging two previously separate repositories (`educore-lms-backend` and `certificate-api`) using `git subtree`, preserving the full content and history of both projects.
